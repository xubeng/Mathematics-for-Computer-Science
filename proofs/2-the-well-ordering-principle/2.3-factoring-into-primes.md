...
If C is not empty, there is a least element n 2 C by WOP. This n can’t be prime, because a prime by itself is considered a \(length one\) product of primes, and no such products are in C
